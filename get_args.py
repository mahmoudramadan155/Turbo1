...
def get_args():
    ...
    parser.add_argument('-train_enc_channel_low', type=float, default  = 3.0)# A Low
    parser.add_argument('-train_enc_channel_high', type=float, default = 1.0)# not used
    parser.add_argument('-train_dec_channel_low', type=float, default  =  3.0)# A Low
    parser.add_argument('-train_dec_channel_high', type=float, default = 1.0)# not used
